...
set "BG_VIDEO="
SET "BG_VIDEO_DIR=background_videos"
SET "BG_VIDEO_FILE=edm_1.mp4"
...
for %%i in ("%INPUT_DIR%\*.mp3") do (
  ...
  call set "BG_VIDEO=%%files[!randomIndex!]%%"
  echo SELECTED BG VIDEO FOR THIS MP3 IS !BG_VIDEO!

  set "FFMPEG_INPUTS=-stream_loop -1 -t !CLIP_DURATION! -i "!BG_VIDEO!" -ss !CLIP_START! -t !CLIP_DURATION! -i "%%i" -i "!LOGO_IMAGE!""

  echo GENERATING 1920 X 1080 clip
  ...
  echo GENERATING 1080 X 1920 clip
